...
@Component({
  selector: 'app-freight-view',
  templateUrl: './freight-view.component.html',
  styleUrls: ['./freight-view.component.css'],
  providers: [ProductService]
})
export class FreightViewComponent implements OnInit {
