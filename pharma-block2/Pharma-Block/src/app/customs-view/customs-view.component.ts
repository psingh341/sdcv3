...
@Component({
  selector: 'app-customs-view',
  templateUrl: './customs-view.component.html',
  styleUrls: ['./customs-view.component.css'],
  providers: [ProductService]
})
export class CustomsViewComponent implements OnInit {
